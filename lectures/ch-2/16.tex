...
\begin{equation}
    \begin{vmatrix}
        \frac{\partial \sigma}{\partial x_1} & 1 0 & \cdots & 0 \\
        \vdots & 0 & \ddots & \ddots & \vdots \\
        \vdots & \vdots & \ddots & \ddots & 0 \\
        \frac{\partial \sigma}{\partial x_n} & 0 & \cdots & 0 & 1 \\
        \frac{1}{\Delta} & -\frac{1}{\Delta} \frac{\partial \sigma}{\partial x_1} & \cdots & \cdots & - \frac{1}{\Delta} \frac{\partial \sigma}{\partial x_n}
...
При різних значеннях $t = t_0$ функція $u(t_1, x)$ відрізняється від $u(t_0, x)$ зсувом на вектор $\frac{\vec \xi b (t_1 - t_0)}{|\vec \xi|^2}$, дійсно:
\begin{equation}
    \begin{aligned}

...
Причини порушення єдності розв'язку у внутрішньої граничної задачі \seqref{4.6.10} і зовнішньої граничної задачі \seqref{4.6.11} різні. \medskip

Для того щоб зрозуміти причину існування нетривіального розв'язку у задачі \seqref{4.6.10} розглянемо більш загальну однорідну задачу з параметром:
\begin{system}
	\label{eq:4.6.12}
...
Аналіз формул \eqref{eq:4.7.10} та \eqref{eq:4.7.14} показує, що при $x \to 0$: $J_n(x) \approx \frac{1}{n!} \left( \frac{x}{2} \right)^n$, $n = 0, 1, 2, \ldots$. \medskip

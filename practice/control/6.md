...
\begin{equation}
	\left\{
		\begin{aligned}
			& \frac{\partial^2 u(r, \varphi, t) = \frac{1}{r} \cdot \frac{\partial}{\partial r} \left( r \cdot \frac{\partial u(r, \varphi, t)}{\partial r} \right) + \frac{1}{r^2} \cdot \frac{\partial^2 u(r, \varphi, t)}{\partial \varphi^2} + f(r, \varphi, t), \newline
			& \ell_i u \vert_{r = r_1} = \ell_j u \vert_{r = r_2} = 0, \newline
			& u(r, \varphi, 0) = u_0(r, \varphi), \newline
			& \frac{\partial u(r, \varphi, 0)}{\partial t} = v_0(r, \varphi).
		\end{aligned}	
	\right.
\end{equation}
$$
...
- зовнішній край _вільний_, тобто $$j = 2$$ і $$\ell_j u = \frac{\partial u}{\partial r}$$;
...
\begin{equation}
	\left\{
		\begin{aligned}
			& \frac{\partial^2 u(r, \varphi, t) = \frac{1}{r} \cdot \frac{\partial}{\partial r} \left( r \cdot \frac{\partial u(r, \varphi, t)}{\partial r} \right) + \frac{1}{r^2} \cdot \frac{\partial^2 u(r, \varphi, t)}{\partial \varphi^2} + f(r), \newline
			& u \vert_{r = r_1}  = \left. \frac{\partial u}{\partial t} \right\vert_{r = r_2} = 0, \newline
			& u(r, \varphi, 0) = u_0(r), \newline
			& \frac{\partial u(r, \varphi, 0)}{\partial t} = 0.
		\end{aligned}	
	\right.
\end{equation}
$$

...
\begin{example}
	...
	\begin{system}
		...
		& \frac{\partial \vecf V}{\partial t} + \Big\langle \vecf V, \nabla \Big\rangle \vecf V + \frac{\nabla p}{\rho} = 0, \\
		& p = p(\rho).
	\end{system}
\end{example}
...
\begin{solution}
	...
	\begin{equation}
		A_0(D) = \begin{pmatrix}
			\dfrac{\partial}{\partial t} + \Big\langle \vecf V, \nabla \Big\rangle & \rho \dfrac{\partial}{\partial x_1} & \rho \dfrac{\partial}{\partial x_2} & \rho \dfrac{\partial}{\partial x_3} \\
			\\
			\dfrac{c^2}{\rho} \dfrac{\partial}{\partial x_1} & \dfrac{\partial}{\partial t} + \Big\langle \vecf V, \nabla \Big\rangle & 0 & 0 \\
			\\
			\dfrac{c^2}{\rho} \dfrac{\partial}{\partial x_2} & 0 & \dfrac{\partial}{\partial t} + \Big\langle \vecf V, \nabla \Big\rangle & 0 \\
			\\
			\dfrac{c^2}{\rho} \dfrac{\partial}{\partial x_3} & 0 & 0 & \dfrac{\partial}{\partial t} + \Big\langle \vecf V, \nabla \Big\rangle
		\end{pmatrix}
	\end{equation}
	...
	\begin{equation}
		\begin{vmatrix}
			\tau + \Big\langle \vecf V, \xi \Big\rangle & \rho \xi_1 & \rho \xi_2 & \rho \xi_3 \\
			\\
			\dfrac{c^2}{\rho} \xi_1 & \tau + \Big\langle \vecf V, \xi \Big\rangle & 0 & 0 \\
			\\
			\dfrac{c^2}{\rho} \xi_2 & 0 & \tau + \Big\langle \vecf V, \xi \Big\rangle & 0 \\
			\\
			\dfrac{c^2}{\rho} \xi_3 & 0 & 0 & \tau + \Big\langle \vecf V, \xi \Big\rangle\\
		\end{vmatrix}
		= 0,
	\end{equation}
	де
	\begin{equation}
		\Big\langle \vecf V, \xi \Big\rangle = \Sum_{i = 1}^3 V_i \xi_i,
	\end{equation}
	а $c^2 = \diff p / \diff \rho$ --- квадрат швидкості звуку. Розкриваючи визначник отримаємо співвідношення
	\begin{equation}
		\left( \tau + \Big\langle \vecf V, \xi \Big\rangle \right)^2 \left(\left( \tau + \Big\langle \vecf V, \xi \Big\rangle \right)^2 - c^2 |\xi|^2 \right) = 0.
	\end{equation}
	...
	\begin{align}
		\tau_{1,2} &= - \Big\langle \vecf V, \xi \Big\rangle, \\
		\tau_{3,4} &= - \Big\langle \vecf V, \xi \Big\rangle \pm c |\xi|, 
	\end{align}

% cls && pdflatex lecture_raster.tex && pdflatex lecture_raster.tex && del lecture_raster.aux, lecture_raster.toc, lecture_raster.log, lecture_raster.out && start lecture_raster.pdf

...
\begin{definition}[характеристичних чисел ядра]
	Комплексні $\lambda$, при яких однорідне інтегральне рівняння Фредгольма ІІ роду має нетривіальні розв'язки, називаються \it{характеристичними числами} ядра $K(x, y)$.
\end{definition}

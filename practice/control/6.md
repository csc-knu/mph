...
\begin{equation}
	\left\{
		\begin{aligned}
			...
			& \frac{\partial u_t(r, \varphi, 0)}{\partial t} = v_0(r, \varphi).
		\end{aligned}	
	\right.
\end{equation}
$$
...
- зовнішній край _вільний_, тобто $$j = 2$$ і $$\ell_j u = \ell_2 u = \frac{\partial u}{\partial r}$$;
...
\begin{equation}
	\left\{
		\begin{aligned}
			...
			& u \vert_{r = r_1}  = \left. \frac{\partial u}{\partial r} \right\vert_{r = r_2} = 0, \newline
			& u(r, \varphi, 0) = u_0(r), \newline
...
- з третьої умови $$\Phi(\varphi) = \text{const}$$, бо $$u_0$$ не залежить від $$\varphi$$. Без обмеження загальності покладемо цю константу рівній $$1$$.

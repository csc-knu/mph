...
\begin{equation}
	u(r, t) = \Sum_{k = 0}^{\infty} \frac{\Int_{r_1}^{r_2} u_0(r) R_k(r) \diff r}{\Int_{r_1}^{r_2} R_k^2(r) \diff r} \cdot \left( \frac{J_0(\mu_k r)}{J_0(\mu_k r_1)} - \frac{N_0(\mu_k r)}{N_0(\mu_k r_1)} \right) \left(\left( 1 - \frac{1}{\mu_k^2} \right) \cos(\mu_k t) + \frac{1}{\mu_k^2}\right).
\end{equation}

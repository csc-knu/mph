...
Записавиш $$u$$ у вигляді $$\Phi(\varphi) \cdot U(r, t)$$ можна показати, що $$\Phi=\text{const}$$. Без обмеження загальності покладемо її рівною $$1$$, тоді система набуде вигляду:
...
<!-- Рівняння неоднорідне, тому будемо шукати розв'язок у вигляді $$u = u_1 + u_2$$, де $$u_1$$ &mdash; розв'язок однорідного рівняння ненульовими початковими умовами, а $$u_2$$ &mdash; розв'язок неодноріного рівняння з нульовими початковими умовами.

Будемо розв'язувати однорідну задачу методом розділення змінних Фур'є, тобто шукати розв'язкок у вигляді $$u_1(r, t) = R(r) \cdot T(t)$$. Підставляючи його в перше рівняння отримаємо

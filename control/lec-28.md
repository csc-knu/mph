...
Значення функціонала $$\ell$$ на елементі $$f$$ &mdash; комплексне число $$\ell f$$ &mdash; будемо позначати через $$\langle\ell, f\rangle$$. Таким чином, _неперервність_ лінійного функціоналу $$\ell$$ значає: якщо $$f_k \to 0$$, $$k \to \infty$$, $$f_k \in M$$, то послідовність комплексних чисел $$\langle \ell, f_k \rangle$$, $$k \to \infty$$ прямує до $$0$$.

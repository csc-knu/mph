...
\begin{equation}
	c_k f_k = \frac{\Int_{r_1}^{r_2} u_0(r) R_k(r) \diff r}{\Int_{r_1}^{r_2} R_k^2(r) \diff r},
\end{equation}

і остаточно розв'язок

\begin{equation}
	u(r, t) = \Sum_{k = 0}^{\infty} \frac{\Int_{r_1}^{r_2} u_0(r) R_k(r) \diff r}{\Int_{r_1}^{r_2} R_k^2(r) \diff r} \cdot \left( \frac{J_0(\mu_k r)}{J_0(\mu_k r_1)} - \frac{N_0(\mu_k r)}{N_0(\mu_k r_1)} \right) \left(\left( f_k - \frac{f_k}{\mu_k^2} \right) \cos(\mu_k t) + \frac{f_k}{\mu_k^2}\right).
\end{equation}

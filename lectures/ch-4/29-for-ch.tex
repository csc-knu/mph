...
В нерівності \eqref{eq:5.2.8} використані наступні позначення $\|u_x\|^2 = \int_\Omega \sum_{i=1}^n u_{x_i}^2(x) \diff x$, $\|u\|^2 = \int_\Omega u^2(x) \diff x$. Якщо $\delta_1 > 0$, то з \eqref{eq:5.2.8} можна отримати 
\begin{equation}
    \label{eq:5.2.9}
